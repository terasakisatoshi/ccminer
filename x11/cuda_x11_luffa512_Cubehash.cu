...
static void rnd512(uint32_t *__restrict__ statebuffer, uint32_t *__restrict__ statechainv)
{
	uint32_t t[40];
	uint32_t chainv[8];
	uint32_t tmp;
...
__device__ __forceinline__
static void rnd512_first(uint32_t *__restrict__ state, uint32_t *__restrict__ buffer)
{
	uint32_t chainv[8];
	uint32_t tmp;
	int i, j;
...
__device__ __forceinline__
static void Update512(uint32_t *__restrict__ statebuffer, uint32_t *__restrict__ statechainv, const uint32_t *__restrict__ data)
{
#pragma unroll
...
/***************************************************/
__device__ __forceinline__
static void finalization512(uint32_t * __restrict__ statebuffer, uint32_t * __restrict__ statechainv, uint32_t *__restrict__ b)
{
	int i, j;
...
__host__ void x11_luffaCubehash512_cpu_hash_64(int thr_id, uint32_t threads, uint32_t startNounce, uint32_t *d_hash)
{
	...
	x11_luffaCubehash512_gpu_hash_64 << <grid, block, 0, gpustream[thr_id]>> >(threads, d_hash);
